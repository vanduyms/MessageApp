...
import 'package:example/channel/channel.dart';
            ...
            appBar: AppBar(
              ...
              title: Column(
                children: [
                  ...
                  Text(
                    '${channel.memberCount} thành viên, ${snapshot.data?.where((e) => e.user!.online).length ?? 0} ${AppLocalizations.of(context).online}',
                    style: TextStyle(
                      color: StreamChatTheme.of(context)
                          .colorTheme
                          .textHighEmphasis
